...
void set_mmc_para(int smc_no,void *sdly_addr )
{
	...
	msg("%s,sdly 50M %d\n",__FUNCTION__,((struct tuning_sdly *)(uboot_buf->boot_data.sdcard_spare_data))->sdly_50M);
	msg("%s,sdly 25M %d\n",__FUNCTION__,((struct tuning_sdly *)(uboot_buf->boot_data.sdcard_spare_data))->sdly_25M);
	return;
}